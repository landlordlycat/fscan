...
```
  ...
  -cookie string
        set poc cookie
  -debug int
        every time to LogErr (default 120)
  -domain string
        smb domain
  -h string
  ...
  -p string
        Select a port,for example: 22 | 1-65535 | 22,80,3306 (default "21,22,80,81,135,139,443,445,1433,3306,5432,6379,7001,8000,8080,8089,9200,11211,27017")
  -ping
